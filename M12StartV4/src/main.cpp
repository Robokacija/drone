...
#define MOTOR_PIN_4_A 26
#define MOTOR_PIN_4_B 25
#define MOTOR_PIN_3_A 13
#define MOTOR_PIN_3_B 27
...
double KpX=3, KiX, KdX, SetPointX;
double KpY=3, KiY, KdY, SetPointY;
double KpZ=3, KiZ, KdZ, SetPointZ;
...
<body>
 ...
 <h3>Motor Control for Testing</h3>
  ...
  <h3>Z Axis</h3>
  KpZ: <input type="range" min="0" max="60" step="1" id="KpZ" value="10"><span id="KpZVal">10</span><br>
...
void loop() {
  ...
  InputX = (atan2(a.acceleration.z,a.acceleration.x)) * 180 / PI -90 ;
  InputY = (atan2(a.acceleration.z,a.acceleration.y)) * 180 / PI  -90;
